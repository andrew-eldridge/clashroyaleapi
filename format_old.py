...
# Tournaments
class TournamentListStruct:
    def __init__(self):
        self.items = []
        self.paging = PagingStruct()
...
class GenericTournamentStruct:
    def __init__(self):
        ...
        self.name = ""
        self.level_cap = 0
        self.first_place_card_prize = 0
        self.capacity = 0
        self.max_capacity = 0
        self.preparation_duration = 0
        self.duration = 0
        self.created_time = ""
        self.game_mode = GameModeStruct()
